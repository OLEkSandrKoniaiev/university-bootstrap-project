window.onload = function () {
    document.querySelector('.center-text_1').style.display = 'block';
    document.querySelector('.center-text_2').style.display = 'block';
    document.querySelector('.center-text_3').style.display = 'block';
    document.querySelector('.center-text_4').style.display = 'block';
    document.querySelector('.center-text_5').style.display = 'block';
};

document.querySelectorAll('.open-dialog-link').forEach(function(link) {
    link.addEventListener('click', function() {
        showDialog('Вибачте, але сторінка ще не розроблена або знаходиться на стадії розробки');
    });
});
  ...
  animatedElements.forEach(function(element) {
    new Waypoint({
      ...
      handler: function() {
        ...
        this.destroy(); // Знищує об'єкт Waypoint після виконання
      },
      offset: "90%" // Анімація спрацьовуватиме, коли користувач прогорне до 95% висоти елементу
    });
  });
});
